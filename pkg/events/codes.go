...
const (
	...
	// OperationChangeCluster is the server response sent on every zone/cluster
	// transition. Its parameters carry the new map identity, notably
	// parameters[0] (cluster string, parsed to derive MapType). Used to track
	// the current zone the player is in.
	OperationChangeCluster = 41
)
